...
public class WordGen {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			if(ans.equals("g")) {
				...
				// setting size of word search puzzle based on number of words used.
				if(num > 5) {
	...
	// Starts process of making the puzzle.
	...
	// Checks if the word fits and where.
	...
	// Puts word in random location in puzzle.
